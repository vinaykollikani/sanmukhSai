...
export const experience: ExperienceItem[] = [
    ...
    description: "Led the complete studio rebrand. Developed comprehensive brand guidelines and marketing collateral.",
    highlights: [
      "Led the studio's rebrand end-to-end, from concept through final guidelines",
      "Authored a 40+ page brand guideline covering logo use, type, and color",
      "Produced marketing collateral adopted across every client-facing channel"
    ],
